...
/** 渲染进程给主进程发送消息，需要回调 */
export function ipcRendererInvoke<T extends keyof IpcInvoke.Renderer>(channel: T, args: Parameters<IpcInvoke.Renderer[T]>[0]): Promise<ReturnType<IpcInvoke.Renderer[T]>> {
