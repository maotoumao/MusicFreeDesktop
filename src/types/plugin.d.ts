declare namespace IPlugin {
    ...
    interface IPluginDefine {
        ...
        /** 根据主键去查询歌曲信息 */
        getMusicInfo?: (musicBase: IMedia.IMediaBase) => Promise<Partial<IMusic.IMusicItem> | null>;
        /** 获取歌词 */
        getLyric?: (musicItem: IMusic.IMusicItemPartial) => Promise<ILyric.ILyricSource | null>;
        /** 获取专辑信息，里面的歌曲分页 */
        getAlbumInfo?: (
            albumItem: IAlbum.IAlbumItem,
            page: number,
    ...
    export type IPluginMeta = {
        ...
        enabled?: boolean;
        /** 音源重定向：目标插件的 platform 名，null/undefined 表示不重定向 */
